            ...
            <Content contentContainerStyle={styles.content}>
                ...
                <View style={{ flex: 1, alignItems: 'center', }}>
                    <View style={{  width: '75%', height: '90%', justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ textAlign: 'center', color: 'white' }}>E-MAIL DE REGISTRO ENVIADO</Text>
                        ...
                        <Text style={{ color: 'white' }}>Si no recibite el E-Mail, solicitalo nuevamente. Y si no lo recibís con tactate con el 4223-2233.</Text>
                    </View>
                </View>

                <Button bordered full style={{ borderColor: 'white', margin: 24, borderRadius: 10 }} onPress={() => handleSend()}>
